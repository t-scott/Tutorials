...
# It's possible to add more to this for your purposes, but the intention was to provide a useful "default" environment 
#          for use on ACCRE with python, R, and jupyter notebooks
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
